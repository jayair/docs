...
Layouts can be applied [in the same way as standard Astro Markdown](/en/guides/markdown-content/#markdown-layouts). You can add a `layout` to [your frontmatter](https://github.com/withastro/astro/tree/main/packages/integrations/mdx/#frontmatter) like so:
